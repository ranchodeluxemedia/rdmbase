...
function bones_scripts_and_styles() {
  ...
  if (!is_admin()) {
    ...
    wp_register_style( 'bones-ie-only', get_stylesheet_directory_uri() . '/assets/css/ie.css', array(), '' );
		...
		wp_register_style( 'bones-animatecss', get_stylesheet_directory_uri() . '/assets/vendor/wow/css/libs/animate.css', array(), '' );
    ...
    wp_register_script( 'bones-wow', get_stylesheet_directory_uri() . '/assets/vendor/wow/dist/wow.min.js', array( 'jquery' ), '', true );
    ...
    wp_enqueue_style( 'bones-ie-only' );
		wp_enqueue_style( 'bones-animatecss' );
